...
def plot_area(xarray, values, ax, label, color=None, ls='-', zorder=5): 
    ...
    ax.fill_between(xarray, below, above, lw=lw, color=color, zorder=zorder, alpha=0.2)
    pass
...
# L2O baselines
plot_area(np.arange(niter_max+1), (list_values_LLGD-fstar)/initial_gap, ax=ax, color='purple', label="LLGD our training setting", zorder=4)
plot_area(np.arange(niter_max+1), (list_values_baseline_LLGD-fstar)/initial_gap, ax=ax, color='purple', label="Baseline LLGD", zorder=4, ls='--')
plot_area(np.arange(niter_max+1), (list_values_RNNprop-fstar)/initial_gap, ax=ax, color='mediumorchid', label="RNNprop our training setting", zorder=4)
plot_area(np.arange(niter_max+1), (list_values_baseline_RNNprop-fstar)/initial_gap, ax=ax, color='mediumorchid', label="RNNprop", ls ='--', zorder=4)
...
fig.tight_layout()
fig.savefig('Figures/logistic_mushrooms.pdf')
fig.show()
# %%
